    ...
    <main class="container">
        <div class="hero">
            ...
            <div class="hero-content">
                ...
                <p>We'd love to hear from you. Get in touch with us for enquiries, orders,
                    or feedback.</p>
            </div>
        </div>
        ...
        <div class="contact-container">
            ...
            <div class="form-container">
                <div class="farmer">
                    <img src="assets/images/farmer.png" alt="Farmer Image">
                </div>
                <div class="booking-container">
                    <p>For more enquiries, fill out the form field.</p>
                    <form class="booking-form" action="core/backend/booking.php" method="POST">
